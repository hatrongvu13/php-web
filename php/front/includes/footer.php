...
<div class="footer-top">
	<div class="container-fluid">
		<div class="col-xs-8 agile-leftmk">
			<h2>Đừng bỏ lỡ bất cứ cơ hội mua hàng hấp dẫn nào nhé</h2>
			<p>Đăng kí để nhận những thông tin mới nhất</p>
		...
		<div class="col-xs-4 w3l-rightmk">
			<img src="source/images/tab3.png" alt=" ">
		</div>
	...
	<div class="container">
		...
		<div class="agile-sometext">
			...
			<div class="sub-some child-momu">
				...
				<ul>
					<li>
						<img src="source/images/pay2.png" alt="">
					</li>
					<li>
						<img src="source/images/pay5.png" alt="">
					</li>
					<li>
						<img src="source/images/pay1.png" alt="">
					</li>
					<li>
						<img src="source/images/pay4.png" alt="">
					</li>
					<li>
						<img src="source/images/pay6.png" alt="">
					</li>
					<li>
						<img src="source/images/pay3.png" alt="">
					</li>
					<li>
						<img src="source/images/pay7.png" alt="">
					</li>
					<li>
						<img src="source/images/pay8.png" alt="">
					</li>
					<li>
						<img src="source/images/pay9.png" alt="">
					</li>
				</ul>
			</div>
			<!-- //payment -->
